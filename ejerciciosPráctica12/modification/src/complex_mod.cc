...
*
* @param complex_1, a constant reference to an object from Complex class.
* @param real, a constant reference to an int number.
* @returns A call to the constructor from Complex class to construct the multiplication object.
*/

Complex operator*(const Complex& complex, const int& real) {
...
*
* @param complex_1, a constant reference to an object from Complex class.
* @param number, a constant reference to a double number.
* @returns A call to the constructor from Complex class to construct the multiplication object.
*/

Complex operator*(const Complex& complex, const double& number) {
  return Complex(number * complex.real(), number * complex.imaginary());
}
...
std::ostream& operator<<(std::ostream &cout, const Complex& complex) {
  if(complex.imaginary() < 0) {cout << complex.real() << " + (" << complex.imaginary() << ")i\n";}
  else if(complex.imaginary() > 0) {cout << complex.real() << " + " << complex.imaginary() << "i\n";}
  return cout;
} 